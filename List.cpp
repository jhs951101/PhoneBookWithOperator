...
{
   data.phoneName = "";
   data.valueInfo.phoneNumber = 0;
   data.valueInfo.emailAddress = "";
   previous = NULL;
   next = NULL;
   //ncount++;
}
Node::Node(Entry s)
{  
   data.phoneName = s.phoneName;
   data.valueInfo.phoneNumber = s.valueInfo.phoneNumber;
   data.valueInfo.emailAddress = s.valueInfo.emailAddress;
   previous = NULL;
   next = NULL;
   //ncount++;
}
